...
public class MoviesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rc_movies);
        ...
        filmViewModel.setMovies(bahasa);
        showLoading(true);

        filmViewModel.getMovies().observe(this, new Observer<ArrayList<Film>>() {
            @Override
